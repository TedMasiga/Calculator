...
const numberBtns = Array.from(document.querySelectorAll('.no'));
const operatorBtns = Array.from(document.querySelectorAll('.ops'));
const clearBtn = document.querySelector('#clearButton');
const equalBtn = document.querySelector('#equalsButton');
